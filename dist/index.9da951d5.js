...
})({"dUgAT":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "739397669da951d5";
...
},{}],"bitlD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _websiteJs = require("./website.js");
var _websiteJsDefault = parcelHelpers.interopDefault(_websiteJs);
_websiteJsDefault.default();
...
parcelHelpers.export(exports, "appendArchives", ()=>appendArchives
);
...
const createContainer = ()=>{
    ...
    container.appendChild(_modalsJs.createModal("add"));
    container.appendChild(_modalsJs.createModal("project"));
...
function createGroup(id) {
    ...
    if (id === "home-group") {
        ...
        for(let i = 0; i < _projectsJs.projectArray.length; i++)group.appendChild(createBtn("project", _projectsJs.projectArray[i]));
    ...
    } else console.log("error in group if statement");
    return group;
}
function createBtn(id, content) {
    ...
    if (id === "project") {
        ...
        projectCounter++;
    } else btn.setAttribute("id", id);
    return btn;
}
let projectMapArray = [];
function chooseID(id, content) {
    const taskArea = document.getElementById("task-area");
    if (id === "add-task") _modalsJs.modalClickAdd();
    else if (id === "add-project") _modalsJs.modalClickProject();
    else if (id === "remove-project") {
        if (_projectsJs.projectArray.length === 0) {
            alert("No Projects in Project List. Add a Project!");
            return;
        } else _modalsJs.modalClickRemove();
    } else if (id === "archive") _modalsJs.modalClickArchive();
    else if (id === "home") appendTasks(allTasks);
    else if (id === "today") _projectsJs.runToday();
    else if (id === "week") _projectsJs.runWeek();
    else if (id === "month") _projectsJs.runMonth();
    else {
        projectMapArray = [];
        allTasks.map(function(obj) {
            if (obj.project === content) projectMapArray.push(obj);
        });
...
exports.default = initializeToDoList;

},{"./task.js":"lODYT","./modals.js":"gbXw2","./projects.js":"lgM2b","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lODYT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function addTaskEdit(num) {
    ...
    taskEdit.addEventListener("click", (e)=>{
        ...
        _modalsJs.modalClickEdit(_websiteJs.allTasks[num].title, _websiteJs.allTasks[num].project, _websiteJs.allTasks[num].priority, _websiteJs.allTasks[num].date, num);
    });
...
function addTaskComplete(num) {
    ...
    taskComplete.innerHTML = '<span class="material-symbols-outlined">check_circle</span>';
    taskComplete.addEventListener("click", (e)=>{
        ...
        let dateTest = taskID.firstChild.nextSibling.nextSibling.nextSibling.textContent;
        _websiteJs.allTasks.map(function(obj, index) {
...
function addArchiveTask(title, project, priority, date, num) {
    const task = document.createElement("div");
...
parcelHelpers.export(exports, "todayArray", ()=>todayArray
);
parcelHelpers.export(exports, "weekArray", ()=>weekArray
);
parcelHelpers.export(exports, "monthArray", ()=>monthArray
);
parcelHelpers.export(exports, "runToday", ()=>runToday
);
parcelHelpers.export(exports, "runWeek", ()=>runWeek
);
parcelHelpers.export(exports, "runMonth", ()=>runMonth
);
var _websiteJs = require("./website.js");
var _dateFns = require("date-fns");
const projectArray = [
...
function runToday() {
    todayArray = [];
    _websiteJs.allTasks.map(function(obj) {
        if (_dateFns.isEqual(new Date(), new Date(obj.date))) todayArray.push(obj);
    });
    _websiteJs.appendTasks(todayArray);
}
function runWeek() {
    weekArray = [];
    let currentWeek = _dateFns.getWeek(new Date());
    _websiteJs.allTasks.map(function(obj) {
        let taskWeek = _dateFns.getWeek(new Date(obj.date));
        if (taskWeek === currentWeek) weekArray.push(obj);
    });
    _websiteJs.appendTasks(weekArray);
}
function runMonth() {
    monthArray = [];
    let currentMonth = _dateFns.getMonth(new Date());
    _websiteJs.allTasks.map(function(obj) {
        let taskMonth = _dateFns.getMonth(new Date(obj.date));
        if (taskMonth === currentMonth) monthArray.push(obj);
    });
    _websiteJs.appendTasks(monthArray);
}

},{"./website.js":"9ARCS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","date-fns":"9yHCA"}],"gkKU3":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"f3U40":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../toDate/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../toDate/index.js":"fsust","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8sqtB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../toDate/index.js":"fsust","../_lib/toInteger/index.js":"f7kKX","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6b4m8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../startOfWeek/index.js":"fD46d","../toDate/index.js":"fsust","../_lib/toInteger/index.js":"f7kKX","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"CNBdH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../toDate/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../toDate/index.js":"fsust","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iOhcx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
